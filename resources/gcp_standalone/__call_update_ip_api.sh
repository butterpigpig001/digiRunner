...
#   --insecure
    ...
    local api_response2=$(curl -s -k -X POST "$API_URL" \
        ...
        -H "authorization: Bearer $access_token" \
        -H 'content-type: application/json' \
        --data '{"ReqHeader":{"txSN":"","txDate":"","txID":"","cID":"","locale":""},"ReqBody":{"id":"TSMP_EDITION","oldVal":"Cn88-nNO8-xx8u-un88-nVoF-Fr48-80rc-L5rF-xN#8-e1=x-6#xo-=d4#-2\u0021=n-\u0021#2\u0021-=\u0021\u0021\u0021-\u0021\u0021\u0021","newVal":"Cn88-nNvl-8xx8-uENn-88nV-G4LL-\u0021\u0021ox-8\u0021\u0021u-nc\u0021o-F8\u0021V-xL\u0021r-x\u002148-\u0021#n\u0021-=L\u0021#-x\u0021=8-\u0021#\u0021\u0021-\u0021\u0021\u0021\u0021-","memo":"TSMP license key-new","encrptionType":"NONE"}}')
